...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Give AI agents a complete mental model of your Rails app — 29 tools via MCP or CLI. Zero config."
  spec.description   = <<~DESC
    ...
    conventions connect. 29 live tools (via MCP server or CLI) let agents query
  ...
  spec.post_install_message = <<~MSG
    rails-ai-context installed! Quick start:
      ...
      rails 'ai:tool[schema]'      # run any of the 29 tools from CLI
